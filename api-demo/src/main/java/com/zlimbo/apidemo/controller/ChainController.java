package com.zlimbo.apidemo.controller;

import com.alibaba.fastjson.JSONObject;
import com.zlimbo.apidemo.mapper.ChainMapper;
...
public class ChainController {
    ...
    String upChain(@RequestBody JSONObject jsonData) {
        ...
        try {
            ...
            int res = chainMapper.upChain(tableName, privateKey, systemId, requestSn, dataInfo);
            if (res == 1) {
