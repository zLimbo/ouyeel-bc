...
var bcinfoUpdate = {
    ...
    success: function (jsonObj) {
        ...
        $("#blockHash").html(jsonObj.blockHash);
...
//         success: function (jsonObj) {
//             alert(jsonObj);
//             $("#systemId").val(jsonObj.systemId);
//             $("#requestSn").val(jsonObj.requestSn);
//             $("#invokeTime").val(jsonObj.invokeTime);
//             $("#businessId").val(jsonObj.businessId);
//             $("#callbackUrl").val(jsonObj.callbackUrl);
//             $("#keyId").val(jsonObj.keyId);
...
//             $("#timestamps").val(jsonObj.timestamps);
//             $("#consumerName").val(jsonObj.consumerName);
//             $("#consumerTaxesNo").val(jsonObj.consumerTaxesNo);
